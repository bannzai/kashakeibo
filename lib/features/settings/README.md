...
匿名ユーザーのデータ寿命を守るための Apple / Google アカウントへのリンク、プラン (無料 / プレミアム) の表示とペイウォールへの導線、アカウント削除、法務ドキュメントへの導線を提供する。
...
2. リンク済みプロバイダで再認証し、R2 の全画像・Firestore の明細とユーザードキュメント・Firebase Auth アカウントを削除する
