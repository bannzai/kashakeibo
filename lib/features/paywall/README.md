...
- 表示内容: 訴求文 `paywallSavingsClaim`「家計簿で支出が減った人の約半数が、月5,000円〜1万円未満の節約を実感*」と、出典注記 `paywallSavingsSource`「* 東証マネ部!「お金に関するアンケート」2022年10月・全国20〜40代の会社員1,111名」
- 出典: 東証マネ部! (JPX 運営メディア)「家計簿をつけている人は節約効果があるのか?」 https://money-bu-jpx.com/news/article042167/
- 数字の根拠: 調査時期 2022年10月・全国20〜40代の会社員・有効回答 1,111 件。家計簿をつけている人のうち「支出が減った」が 34.1%、その支出が減った人のうち月「5,000円〜1万円未満」の節約が 48.6% (最多)。文言の「約半数」「月5,000円〜1万円未満」はこの 48.6% と価格帯に対応する。誇大表示にしないため、文言の数字は原典と一致させる
...
2. 料金カードを選び「プレミアムを始める」でストアの購入シートを開く (`purchasePremiumPackageProvider`)。キャンセルは何も表示せず開いたまま、失敗はエラー文をそのまま表示する
   - 購入後の RevenueCat entitlement が trial なら `trial_start`、それ以外の有効な課金期間なら `purchase_complete` を Analytics に記録する
