...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/610d4f06-927a-4d5f-b76b-81d7fa80b845.png" width="320" alt="条件未入力で「検索条件を1つ以上入力してください」が表示された検索画面" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/ce2e1b0c-5819-4a5f-ab71-b8ed9e188209.png" width="320" alt="「条件をクリア」をタップして入力欄と結果が初期状態に戻った検索画面" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/e93ed61d-045e-4f53-9334-ec89726d838e.png" width="320" alt="終了日が開始日より前で「終了日は開始日以降にしてください」が表示された検索画面" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/bf1962bd-1223-4e5d-b2e3-009ec50328da.png" width="320" alt="最大金額が最小金額より小さく「最大金額は最小金額以上にしてください」が表示された検索画面" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/682de900-975e-4d26-8913-3b3d97b736d0.png" width="320" alt="開始日 8/21・終了日 8/22 で絞り込み、期間内の 2 件が新しい順に並んだ検索結果" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/c62dfa84-a2a7-4732-9c39-7995a7800376.png" width="320" alt="最小 ¥500・最大 ¥5000 で絞り込み、範囲内の 3 件だけが並んだ検索結果" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/a8dc1e8f-ec6b-4ff4-a21f-97515ea6f210.png" width="320" alt="取引先「スーパー」で部分一致した 1 件だけが表示された検索結果" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/6287ccdc-ffe9-4ba4-aaab-1d64df8bcfbe.png" width="320" alt="金額 ¥500〜¥5000 と取引先「ドラッグ」を同時に指定し、両方を満たす 1 件だけが表示された検索結果" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/bf2f1905-99ed-4af6-8bda-406ca1c9c5dd.png" width="320" alt="一致する明細が無く「条件に一致する明細はありません」が表示された検索結果" />
...
<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/74025674-9bb2-4c08-ab7d-c95923c1f907.png" width="320" alt="検索結果の行をタップして開いた「ドラッグストア ¥880」の明細詳細画面" />
...
- [x] **無料プランの注記表示**: 無料プランでは検索フォームの下に「無料プランでは直近3ヶ月の明細だけを検索できます」の注記が表示され、タップでペイウォールが開ける (検索結果には直近3ヶ月より古い明細が含まれない)
  - 自動化: manual (絞り込み自体は test/provider/transaction_search_test.dart の下限適用テストで検証している)
...
無料プラン状態で検索画面に注記が表示された。下限適用後も既存 (直近) の明細検索は「1. 検索フォーム」「2. 検索の実行」のとおり動作する。3ヶ月より古い明細の非表示は、古い明細の作り込みが必要なためシミュレータでは未実施 (下限の適用ロジックは provider テストで検証済み)。

<img src="https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/kashakeibo/20260823/892639df-ee29-439a-b97d-237eebf5bded.png" width="320" alt="無料プランで「直近3ヶ月の明細だけを検索できます」の注記が表示された検索画面" />
