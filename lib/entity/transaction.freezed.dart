...
@TimestampConverter() DateTime get transactionDate;/// 取引月 ("2026-08" 形式)。月次一覧のクエリ用フィールド。
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userID,type,amount,category,title,transactionDate,yearMonth,excludedFromAggregation,serverCreatedDateTime,serverUpdatedDateTime);

@override
String toString() {
  return 'Transaction(id: $id, userID: $userID, type: $type, amount: $amount, category: $category, title: $title, transactionDate: $transactionDate, yearMonth: $yearMonth, excludedFromAggregation: $excludedFromAggregation, serverCreatedDateTime: $serverCreatedDateTime, serverUpdatedDateTime: $serverUpdatedDateTime)';
}
...
@useResult
$Res call({
 String id, String userID, TransactionType type, int amount,@JsonKey(unknownEnumValue: TransactionCategory.other) TransactionCategory category, String title,@TimestampConverter() DateTime transactionDate, String yearMonth, bool excludedFromAggregation,@ServerCreatedTimestamp() DateTime? serverCreatedDateTime,@ServerUpdatedTimestamp() DateTime? serverUpdatedDateTime
});
...
/// Create a copy of Transaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userID = null,Object? type = null,Object? amount = null,Object? category = null,Object? title = null,Object? transactionDate = null,Object? yearMonth = null,Object? excludedFromAggregation = null,Object? serverCreatedDateTime = freezed,Object? serverUpdatedDateTime = freezed,}) {
...
as DateTime,yearMonth: null == yearMonth ? _self.yearMonth : yearMonth // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userID,  TransactionType type,  int amount, @JsonKey(unknownEnumValue: TransactionCategory.other)  TransactionCategory category,  String title, @TimestampConverter()  DateTime transactionDate,  String yearMonth,  bool excludedFromAggregation, @ServerCreatedTimestamp()  DateTime? serverCreatedDateTime, @ServerUpdatedTimestamp()  DateTime? serverUpdatedDateTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Transaction() when $default != null:
return $default(_that.id,_that.userID,_that.type,_that.amount,_that.category,_that.title,_that.transactionDate,_that.yearMonth,_that.excludedFromAggregation,_that.serverCreatedDateTime,_that.serverUpdatedDateTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userID,  TransactionType type,  int amount, @JsonKey(unknownEnumValue: TransactionCategory.other)  TransactionCategory category,  String title, @TimestampConverter()  DateTime transactionDate,  String yearMonth,  bool excludedFromAggregation, @ServerCreatedTimestamp()  DateTime? serverCreatedDateTime, @ServerUpdatedTimestamp()  DateTime? serverUpdatedDateTime)  $default,) {final _that = this;
switch (_that) {
case _Transaction():
return $default(_that.id,_that.userID,_that.type,_that.amount,_that.category,_that.title,_that.transactionDate,_that.yearMonth,_that.excludedFromAggregation,_that.serverCreatedDateTime,_that.serverUpdatedDateTime);case _:
  throw StateError('Unexpected subclass');
...
/// Create a copy of Transaction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userID = null,Object? type = null,Object? amount = null,Object? category = null,Object? title = null,Object? transactionDate = null,Object? yearMonth = null,Object? excludedFromAggregation = null,Object? serverCreatedDateTime = freezed,Object? serverUpdatedDateTime = freezed,}) {
