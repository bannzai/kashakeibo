...
このアプリは Flutter 製で、バックエンドは Firebase (Firestore / Cloud Storage / Firebase AI Logic / Analytics / 匿名認証) を採用しています。MVP では Cloud Functions を持たず、サーバーコードゼロで構成します。課金は RevenueCat (purchases_flutter) です。
